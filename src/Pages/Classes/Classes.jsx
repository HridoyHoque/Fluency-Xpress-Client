...
const Classes = () => {
    ...
    const handleSelectClasses = classItem => {
        ...
        if (user) {
            const selectedClass = {
                itemId: classItem._id, name: classItem.name, image: classItem.image, instructorName: classItem.instructorName, price: classItem.price, seats: parseInt(classItem.seats), studentEmail: user.email
            }
